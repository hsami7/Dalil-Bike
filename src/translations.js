...
const translations = {
  en: {
    ...
    // Place Detail page
    status: "Status",
    heritageProtected: "Protected",
    visitorInfo: "Visitor Information",
    openingHours: "Opening Hours",
    openingHoursValue: "Daily: 9:00 AM – 6:00 PM",
    locationLabel: "Location",
    entryFee: "Entry Fee",
    entryFeeValue: "Varies by site",
    ...
    pedalChargeDesc: "Explore Marrakech while pedaling and charging your device.",
  ...
  fr: {
    ...
    status: "Statut",
    heritageProtected: "Protégé",
    visitorInfo: "Informations Visiteurs",
    openingHours: "Horaires d'Ouverture",
    openingHoursValue: "Tous les jours : 9h00 – 18h00",
    ...
    pedalChargeDesc: "Explorez Marrakech en pédalant tout en rechargeant votre appareil.",
  ...
  es: {
    ...
    status: "Estado",
    heritageProtected: "Protegido",
    visitorInfo: "Información para Visitantes",
    openingHours: "Horario de Apertura",
    openingHoursValue: "Diario: 9:00 – 18:00",
    ...
    pedalChargeDesc: "Explora Marrakech pedaleando mientras cargas tu dispositivo.",
  ...
  ar: {
    ...
    pedalChargeDesc: "استكشف مراكش أثناء التبديل وشحن جهازك.",
